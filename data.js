...
const CARBON_DATA = [
  ...
  {
    id: "veggie-burger",
    name: "Veggie burger (plant-based)",
    category: "food",
    unit: "per burger",
    kg_co2: 0.5,
    emoji: "🌱",
    description: "A plant-based burger — think Beyond Burger, bean patty, or mushroom burger — has roughly 90% lower emissions than a beef equivalent. The main footprint comes from processing and packaging, not the ingredients themselves.",
    fun_fact: "A veggie burger emits about the same CO₂ as cycling 3 km. A beef burger? More like 28 km of driving.",
    equivalents: ["About the same as a cup of black coffee", "500 charges of your smartphone"],
    tip: "You genuinely cannot taste the difference in a well-made veggie burger. Don't knock it till you've tried a good one.",
    context_good: "Bean and lentil-based patties have an even lower footprint than highly processed meat-alternative products."
  },
  {
    id: "vegan-cheese",
    name: "Vegan cheese",
    ...
    kg_co2: 0.9,
    emoji: "🧀",
    description: "Vegan cheese is typically made from nuts (cashew, almond), soy, or coconut oil. Its carbon footprint is significantly lower than dairy cheddar — though nut-based varieties can have high water usage, particularly almonds.",
    fun_fact: "Vegan cheese has roughly 60–75% lower carbon emissions than dairy cheddar for the same amount.",
    equivalents: ["About the same as 3 bananas", "Similar to a 4 km bus ride"],
    tip: "Cashew-based vegan cheese tends to be the creamiest and most versatile. Coconut oil-based varieties have the lowest carbon but also the least flavour nuance — you decide what matters more.",
    context_good: "Fermented and aged vegan cheeses are closing the gap in taste — give them a chance before dismissing."
  },
